...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        [
         // Whitespace
         [PR['PR_PLAIN'],  /^[\t\n\r \xA0]+/, null, '\t\n\r \xA0'],
         // A single quoted, possibly multi-line, string. No escaping for closing quote.
         // (Double-quoted strings are identifier names in Oracle SQL.)
         [PR['PR_STRING'], /^'[^']*'/, null, "'"]
        ],
        [
